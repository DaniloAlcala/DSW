...
<body>
    ...
    <form class="d-block p-3 m-4 h-100" class="formulario" name="formulario" method="POST" enctype="multipart/form-data" autocomplete="off" onsubmit="showAlert()">
        ...
        <div class="filas">
            ...
            <div class="fila">
                <div class="columna">
                    ...
                    <select class="form-control select" id="tipo_documento" name="tipo_documento" value="<?php echo htmlspecialchars($student_data['tipo_documento'] ?? ''); ?>" disabled>
            ...
            <div class="fila">
                <div class="columna">
                    ...
                    <select class="form-control select" id="genero" name="genero" value="<?php echo htmlspecialchars($student_data['genero'] ?? ''); ?>" disabled>
        ...
        <div class="fila">
            <div class="columna">
                ...
                <select class="form-control select" id="familia_a_cargo" name="familia_a_cargo" value="<?php echo htmlspecialchars($student_data['familia_a_cargo'] ?? ''); ?>" disabled>
            ...
            <div class="columna">
                ...
                <select class="form-control select" id="hijos" name="hijos" value="<?php echo htmlspecialchars($student_data['hijos'] ?? ''); ?>" disabled>
            ...
            <div class="columna">
                ...
                <select class="form-control select" id="trabaja" name="trabaja" value="<?php echo htmlspecialchars($student_data['trabaja'] ?? ''); ?>" disabled>
        ...
        <div class="filas">
            ...
            <div class="fila">
                ...
                <div class="columna">
                    ...
                    <select class="form-control select" id="titulo_certificado" name="titulo_certificado" placeholder="Título Certificado" value="<?php echo htmlspecialchars($student_data['titulo_certificado'] ?? ''); ?>" disabled>
                ...
                <div class="columna">
                    ...
                    <select class="form-control select" id="titulo_tecnico" name="titulo_tecnico" placeholder="Título Técnico" value="<?php echo htmlspecialchars($student_data['titulo_tecnico'] ?? ''); ?>" disabled>
                ...
                <div class="columna">
                    ...
                    <select class="form-control select" id="titulo_hab" name="titulo_hab" placeholder="Título Habilitante" value="<?php echo htmlspecialchars($student_data['titulo_hab'] ?? ''); ?>" disabled>
        ...
        <div class="fila">
            ...
            <div class="columna">
                ...
                <select class="form-control select" id="documentacion_completa" name="documentacion_completa" value="<?php echo htmlspecialchars($student_data['documentacion_completa'] ?? ''); ?>" disabled>
                    <option value="Sí" <?php echo (htmlspecialchars($student_data['documentacion_completa'] ?? '') === 'Sí') ? 'selected' : ''; ?>>Sí</option>
                    <option value="No" <?php echo (htmlspecialchars($student_data['documentacion_completa'] ?? '') === 'No') ? 'selected' : ''; ?>>No</option>
                </select>
            </div>
            <div class="columna">
            ...
            <div class="filas">
                <div class="fila">
                    <div class="columna">
                        ...
                        <input type="text" class="form-control" id="plan_carrera" name="plan_carrera" placeholder="Plan de Carrera" value="<?php echo htmlspecialchars($student_data['plan_carrera'] ?? ''); ?>" disabled/>
                    </div>
                    <div class="columna">
                        <label class="form-label text-black-50" for="estado_inscripcion">Estado de Inscripción *</label>
                        <select class="form-control select" id="estado_inscripcion" name="estado_inscripcion" value="<?php echo htmlspecialchars($student_data['estado_inscripcion'] ?? ''); ?>" disabled>
                    ...
                    <div class="columna">
                        ...
                        <select class="form-control select" id="estado_estudiante" name="estado_estudiante" value="<?php echo htmlspecialchars($student_data['estado_estudiante'] ?? ''); ?>" disabled>
