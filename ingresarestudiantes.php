...
<body>
  ...
  <form class="d-block p-3 m-4 h-100" class="formulario" name="formulario" method="POST" enctype="multipart/form-data" autocomplete="on" onsubmit="showAlert()">
